...
<head>
    ...
    <title>Data Pelamar | SICARE RSIH</title>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Data Pelamar
                            <small>Detail pelamar Approved RSIH</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                    ...
                                    <a href='export.php?id=approved' target="_BLANK" class='btn btn-sm btn-success'> <span class="glyphicon glyphicon-export"> </span> Export to Excel</a>
