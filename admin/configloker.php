                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    <form class="form-horizontal " method="post" action="control/updateconfig.php">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                            ...
                                            <?php
                                                ...
                                                if (mysqli_num_rows($result) > 0) {
                                                    ...
                                                    while($row = mysqli_fetch_array($result)) {      
                                                        ...
                                                        echo "	<td>".$no."</td>";    
                                                        echo "	<td>".$row["nama"]."</td>";
                                                        echo "	<td width='15%' align='center'> <a href='control/hapusbagian.php?id=$row[no]' class='btn btn-sm btn-danger'><span class='glyphicon glyphicon-trash'> </span> Hapus</a> </td>";
                                                        echo "</tr>";   
                                                        $no++;
                                                    }
                                                echo "</table>";    
                                ...
                                <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#myModal"><span class="glyphicon glyphicon-plus"> </span> Tambah Bagian</button> <a href='control/hapus.php' class='btn btn-sm btn-warning' onclick="return confirm('Apakah anda yakin?')"><span class="glyphicon glyphicon-trash"> </span> Hapus Semua Bagian</a>
                            </div>
                        </div>
                    </div>
                </div>
